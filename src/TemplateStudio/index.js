...
class TemplateStudio extends Component {
  ...
  loadTemplateLibrary() {
    const templateLibrary = new TemplateLibrary('https://5d82407337e96a00077a90cd--templates-accordproject.netlify.com');
    const promisedIndex =
  ...
  loadTemplateFromUrl(templateURL) {
    const thisTemplateURL =
      templateURL.replace('ap://','https://5d82407337e96a00077a90cd--templates-accordproject.netlify.com/archives/').replace('#hash','.cta');
